...
%define _conf_dir    %{_prefix}/storm/conf
%define _log_dir     %{_prefix}/storm/logs
%define _data_dir    %{_prefix}/storm/data
...
Source0: http://mirrors.advancedhosters.com/apache/storm/apache-storm-%{version}/apache-storm-%{version}.tar.gz
...
Packager: Kodelint <kodelint@gmail.com>
Provides: storm
